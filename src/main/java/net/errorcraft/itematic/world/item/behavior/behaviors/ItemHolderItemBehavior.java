...
public record ItemHolderItemBehavior(Fraction capacity, ItemHolderRules rules, Holder<SoundEvent> insertItemSound, Holder<SoundEvent> removeItemSound, Holder<SoundEvent> emptySound) implements ItemBehavior<ItemHolderItemBehavior> {
    ...
    public static ItemHolderItemBehavior of(int capacity, ItemHolderRules rules, Holder<SoundEvent> insertItemSound, Holder<SoundEvent> removeItemSound, Holder<SoundEvent> emptySound) {
        return new ItemHolderItemBehavior(Fraction.getFraction(capacity, 1), rules, insertItemSound, removeItemSound, emptySound);
    }
