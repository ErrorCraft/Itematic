...
public class Trades {
    ...
    public static void bootstrap(BootstrapContext<Trade> registerable) {
        ...
        registerable.register(SELL_NIGHT_VISION_SUSPICIOUS_STEW, sellSuspiciousStew(items, statusEffects.getOrThrow(MobEffectKeys.NIGHT_VISION), 100));
        registerable.register(SELL_JUMP_BOOST_SUSPICIOUS_STEW, sellSuspiciousStew(items, statusEffects.getOrThrow(MobEffectKeys.JUMP_BOOST), 160));
        registerable.register(SELL_WEAKNESS_SUSPICIOUS_STEW, sellSuspiciousStew(items, statusEffects.getOrThrow(MobEffectKeys.WEAKNESS), 140));
        registerable.register(SELL_BLINDNESS_SUSPICIOUS_STEW, sellSuspiciousStew(items, statusEffects.getOrThrow(MobEffectKeys.BLINDNESS), 120));
        registerable.register(SELL_POISON_SUSPICIOUS_STEW, sellSuspiciousStew(items, statusEffects.getOrThrow(MobEffectKeys.POISON), 280));
        registerable.register(SELL_SATURATION_SUSPICIOUS_STEW, sellSuspiciousStew(items, statusEffects.getOrThrow(MobEffectKeys.SATURATION), 7));
