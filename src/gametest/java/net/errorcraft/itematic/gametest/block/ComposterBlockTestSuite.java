...
public class ComposterBlockTestSuite {
    ...
    public void usingCompostableItemOnComposterIncreasesLevel(GameTestHelper context) {
        ...
        player.setItemInHand(InteractionHand.MAIN_HAND, context.getLevel().itematic$createStack(ItemKeys.PUMPKIN_PIE));
    ...
    public void usingBlockOnFullComposterEmptiesComposterAndSpawnsBoneMeal(GameTestHelper context) {
        ...
        context.succeedIf(() -> {
            ...
            context.assertItemEntityPresent(context.getLevel().itematic$getItem(ItemKeys.BONE_MEAL).value());
        });
    }
}
