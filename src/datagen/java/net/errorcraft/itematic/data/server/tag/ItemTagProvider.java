...
public class ItemTagProvider extends FabricTagProvider<Item> {
    ...
    protected void configure(RegistryWrapper.WrapperLookup lookup) {
        ...
        this.builder(ItematicItemTags.BUNDLES)
            ...
            .add(ItemKeys.GRAY_BUNDLE)
            .add(ItemKeys.BLACK_BUNDLE)
            .add(ItemKeys.BROWN_BUNDLE)
            .add(ItemKeys.RED_BUNDLE)
            .add(ItemKeys.ORANGE_BUNDLE)
            .add(ItemKeys.YELLOW_BUNDLE)
            .add(ItemKeys.LIME_BUNDLE)
            .add(ItemKeys.GREEN_BUNDLE)
            .add(ItemKeys.CYAN_BUNDLE)
            .add(ItemKeys.LIGHT_BLUE_BUNDLE)
            .add(ItemKeys.BLUE_BUNDLE)
        ...
        this.builder(ItematicItemTags.HARNESSES)
            ...
            .add(ItemKeys.BLACK_HARNESS)
            .add(ItemKeys.BROWN_HARNESS)
            .add(ItemKeys.RED_HARNESS)
            .add(ItemKeys.ORANGE_HARNESS)
            .add(ItemKeys.YELLOW_HARNESS)
            .add(ItemKeys.LIME_HARNESS)
            .add(ItemKeys.GREEN_HARNESS)
            .add(ItemKeys.CYAN_HARNESS)
            .add(ItemKeys.LIGHT_BLUE_HARNESS)
            .add(ItemKeys.BLUE_HARNESS)
