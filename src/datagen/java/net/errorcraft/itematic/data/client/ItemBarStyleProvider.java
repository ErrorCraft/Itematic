...
public class ItemBarStyleProvider extends FabricCodecDataProvider<ItemBarStyle> {
    public ItemBarStyleProvider(FabricPackOutput output, CompletableFuture<HolderLookup.Provider> registriesFuture) {
        super(output, registriesFuture, PackOutput.Target.RESOURCE_PACK, "item_bar_style", ItemBarStyle.CODEC);
    }
