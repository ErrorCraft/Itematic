package net.errorcraft.itematic.world.item.weapon.melee;
...
public record SmashingWeapon(HitSounds hitSounds, double smashAttackFallDistance, double heavySmashAttackFallDistance, double knockbackPower) {
    ...
    public static final StreamCodec<RegistryFriendlyByteBuf, SmashingWeapon> STREAM_CODEC = StreamCodec.composite(
        HitSounds.STREAM_CODEC, SmashingWeapon::hitSounds,
    ...
    public record HitSounds(Holder<SoundEvent> inAir, Holder<SoundEvent> onGroundSmallFallDistance, Holder<SoundEvent> onGroundLargeFallDistance) {
        ...
        public static final StreamCodec<RegistryFriendlyByteBuf, HitSounds> STREAM_CODEC = StreamCodec.composite(
