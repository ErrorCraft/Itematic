...
@Mixin(Camel.class)
public abstract class CamelExtender extends MobExtender {
    protected CamelExtender(EntityType<? extends LivingEntity> type, Level level) {
        super(type, level);
    }
    ...
    protected @Nullable ResourceKey<Item> pickResultItem() {
        return ItemIds.CAMEL_SPAWN_EGG;
    }
}
