...
public class ThrowableItemComponentTestSuite {
    ...
    public void throwingEggSpawnsEggAtEyePosition(GameTestHelper helper) {
        ...
        helper.succeedIf(() -> {
            ...
            helper.assertEntityPresent(EntityTypes.EGG, SPAWN_POSITION.offset(0, (int) player.getEyeHeight(), 0));
        });
    }
    ...
    public void throwingEnderPearlSpawnsEnderPearlAtEyePosition(GameTestHelper helper) {
        ...
        helper.succeedIf(() -> {
            ...
            helper.assertEntityPresent(EntityTypes.ENDER_PEARL, SPAWN_POSITION.offset(0, (int) player.getEyeHeight(), 0));
        });
    }
    ...
    public void throwingSnowballSpawnsSnowballAtEyePosition(GameTestHelper helper) {
        ...
        helper.succeedIf(() -> {
            ...
            helper.assertEntityPresent(EntityTypes.SNOWBALL, SPAWN_POSITION.offset(0, (int) player.getEyeHeight(), 0));
        });
    }
    ...
    public void throwingExperienceBottleSpawnsExperienceBottleAtEyePosition(GameTestHelper helper) {
        ...
        helper.succeedIf(() -> {
            ...
            helper.assertEntityPresent(EntityTypes.EXPERIENCE_BOTTLE, SPAWN_POSITION.offset(0, (int) player.getEyeHeight(), 0));
        });
    }
    ...
    public void throwingSplashPotionSpawnsPotionAtEyePosition(GameTestHelper helper) {
        ...
        helper.succeedIf(() -> {
            ...
            helper.assertEntityPresent(EntityTypes.SPLASH_POTION, SPAWN_POSITION.offset(0, (int) player.getEyeHeight(), 0));
        });
    }
    ...
    public void throwingLingeringPotionSpawnsPotionAtEyePosition(GameTestHelper helper) {
        ...
        helper.succeedIf(() -> {
            ...
            helper.assertEntityPresent(EntityTypes.LINGERING_POTION, SPAWN_POSITION.offset(0, (int) player.getEyeHeight(), 0));
        });
    }
    ...
    public void throwingTridentSpawnsTridentAtEyePosition(GameTestHelper helper) {
        ...
        helper.startSequence()
            ...
            .thenExecuteAfter(minDrawDuration, () -> {
                ...
                helper.assertEntityPresent(EntityTypes.TRIDENT, SPAWN_POSITION.offset(0, (int) player.getEyeHeight(), 0));
            })
            .thenSucceed();
    }
}
