...
public record WeaponAttackDamage(List<Rule> rules, double defaultDamage) {
    ...
    public static final StreamCodec<RegistryFriendlyByteBuf, WeaponAttackDamage> STREAM_CODEC = StreamCodec.composite(
        Rule.STREAM_CODEC.apply(ByteBufCodecs.list()), WeaponAttackDamage::rules,
