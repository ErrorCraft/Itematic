...
public class ItemUtil {
    ...
    public static void bootstrap(Registerable<Item> registerable) {
        ...
        registerable.register(ItemKeys.COAL, create(new ItemBase(ItemBaseDisplay.Builder.forItem(ItemKeys.COAL).build(), 64), ItemComponentSet.builder().with(new FuelItemComponent(1600)).build()));
        registerable.register(ItemKeys.WOODEN_SWORD, create(new ItemBase(ItemBaseDisplay.Builder.forItem(ItemKeys.WOODEN_SWORD).build(), 1), ItemComponentSet.builder().with(ToolItemComponent.from(ToolMaterials.WOOD, 2)).with(new WeaponItemComponent(1), new FuelItemComponent(200)).build()));
        registerable.register(ItemKeys.WOODEN_SHOVEL, create(new ItemBase(ItemBaseDisplay.Builder.forItem(ItemKeys.WOODEN_SHOVEL).build(), 1), ItemComponentSet.builder().with(ToolItemComponent.from(ToolMaterials.WOOD, 1, BlockTags.SHOVEL_MINEABLE)).with(new WeaponItemComponent(2), new FuelItemComponent(200)).build()));
        registerable.register(ItemKeys.WOODEN_PICKAXE, create(new ItemBase(ItemBaseDisplay.Builder.forItem(ItemKeys.WOODEN_PICKAXE).build(), 1), ItemComponentSet.builder().with(ToolItemComponent.from(ToolMaterials.WOOD, 1, BlockTags.PICKAXE_MINEABLE)).with(new WeaponItemComponent(2), new FuelItemComponent(200)).build()));
        registerable.register(ItemKeys.WOODEN_AXE, create(new ItemBase(ItemBaseDisplay.Builder.forItem(ItemKeys.WOODEN_AXE).build(), 1), ItemComponentSet.builder().with(ToolItemComponent.from(ToolMaterials.WOOD, 1, BlockTags.AXE_MINEABLE)).with(new WeaponItemComponent(2), new FuelItemComponent(200)).build()));
        registerable.register(ItemKeys.WOODEN_HOE, create(new ItemBase(ItemBaseDisplay.Builder.forItem(ItemKeys.WOODEN_HOE).build(), 1), ItemComponentSet.builder().with(ToolItemComponent.from(ToolMaterials.WOOD, 1, BlockTags.HOE_MINEABLE)).with(new WeaponItemComponent(2), new FuelItemComponent(200)).build()));
        registerable.register(ItemKeys.STONE_SWORD, create(new ItemBase(ItemBaseDisplay.Builder.forItem(ItemKeys.STONE_SWORD).build(), 1), ItemComponentSet.builder().with(ToolItemComponent.from(ToolMaterials.STONE, 2)).with(new WeaponItemComponent(1)).build()));
        registerable.register(ItemKeys.STONE_SHOVEL, create(new ItemBase(ItemBaseDisplay.Builder.forItem(ItemKeys.STONE_SHOVEL).build(), 1), ItemComponentSet.builder().with(ToolItemComponent.from(ToolMaterials.STONE, 1, BlockTags.SHOVEL_MINEABLE)).with(new WeaponItemComponent(2)).build()));
        registerable.register(ItemKeys.STONE_PICKAXE, create(new ItemBase(ItemBaseDisplay.Builder.forItem(ItemKeys.STONE_PICKAXE).build(), 1), ItemComponentSet.builder().with(ToolItemComponent.from(ToolMaterials.STONE, 1, BlockTags.PICKAXE_MINEABLE)).with(new WeaponItemComponent(2)).build()));
        registerable.register(ItemKeys.STONE_AXE, create(new ItemBase(ItemBaseDisplay.Builder.forItem(ItemKeys.STONE_AXE).build(), 1), ItemComponentSet.builder().with(ToolItemComponent.from(ToolMaterials.STONE, 1, BlockTags.AXE_MINEABLE)).with(new WeaponItemComponent(2)).build()));
        registerable.register(ItemKeys.STONE_HOE, create(new ItemBase(ItemBaseDisplay.Builder.forItem(ItemKeys.STONE_HOE).build(), 1), ItemComponentSet.builder().with(ToolItemComponent.from(ToolMaterials.STONE, 1, BlockTags.HOE_MINEABLE)).with(new WeaponItemComponent(2)).build()));
        registerable.register(ItemKeys.GOLDEN_SWORD, create(new ItemBase(ItemBaseDisplay.Builder.forItem(ItemKeys.GOLDEN_SWORD).build(), 1), ItemComponentSet.builder().with(ToolItemComponent.from(ToolMaterials.GOLD, 2)).with(new WeaponItemComponent(1)).build()));
        registerable.register(ItemKeys.GOLDEN_SHOVEL, create(new ItemBase(ItemBaseDisplay.Builder.forItem(ItemKeys.GOLDEN_SHOVEL).build(), 1), ItemComponentSet.builder().with(ToolItemComponent.from(ToolMaterials.GOLD, 1, BlockTags.SHOVEL_MINEABLE)).with(new WeaponItemComponent(2)).build()));
        registerable.register(ItemKeys.GOLDEN_PICKAXE, create(new ItemBase(ItemBaseDisplay.Builder.forItem(ItemKeys.GOLDEN_PICKAXE).build(), 1), ItemComponentSet.builder().with(ToolItemComponent.from(ToolMaterials.GOLD, 1, BlockTags.PICKAXE_MINEABLE)).with(new WeaponItemComponent(2)).build()));
        registerable.register(ItemKeys.GOLDEN_AXE, create(new ItemBase(ItemBaseDisplay.Builder.forItem(ItemKeys.GOLDEN_AXE).build(), 1), ItemComponentSet.builder().with(ToolItemComponent.from(ToolMaterials.GOLD, 1, BlockTags.AXE_MINEABLE)).with(new WeaponItemComponent(2)).build()));
        registerable.register(ItemKeys.GOLDEN_HOE, create(new ItemBase(ItemBaseDisplay.Builder.forItem(ItemKeys.GOLDEN_HOE).build(), 1), ItemComponentSet.builder().with(ToolItemComponent.from(ToolMaterials.GOLD, 1, BlockTags.HOE_MINEABLE)).with(new WeaponItemComponent(2)).build()));
        registerable.register(ItemKeys.IRON_SWORD, create(new ItemBase(ItemBaseDisplay.Builder.forItem(ItemKeys.IRON_SWORD).build(), 1), ItemComponentSet.builder().with(ToolItemComponent.from(ToolMaterials.IRON, 2)).with(new WeaponItemComponent(1)).build()));
        registerable.register(ItemKeys.IRON_SHOVEL, create(new ItemBase(ItemBaseDisplay.Builder.forItem(ItemKeys.IRON_SHOVEL).build(), 1), ItemComponentSet.builder().with(ToolItemComponent.from(ToolMaterials.IRON, 1, BlockTags.SHOVEL_MINEABLE)).with(new WeaponItemComponent(2)).build()));
        registerable.register(ItemKeys.IRON_PICKAXE, create(new ItemBase(ItemBaseDisplay.Builder.forItem(ItemKeys.IRON_PICKAXE).build(), 1), ItemComponentSet.builder().with(ToolItemComponent.from(ToolMaterials.IRON, 1, BlockTags.PICKAXE_MINEABLE)).with(new WeaponItemComponent(2)).build()));
        registerable.register(ItemKeys.IRON_AXE, create(new ItemBase(ItemBaseDisplay.Builder.forItem(ItemKeys.IRON_AXE).build(), 1), ItemComponentSet.builder().with(ToolItemComponent.from(ToolMaterials.IRON, 1, BlockTags.AXE_MINEABLE)).with(new WeaponItemComponent(2)).build()));
        registerable.register(ItemKeys.IRON_HOE, create(new ItemBase(ItemBaseDisplay.Builder.forItem(ItemKeys.IRON_HOE).build(), 1), ItemComponentSet.builder().with(ToolItemComponent.from(ToolMaterials.IRON, 1, BlockTags.HOE_MINEABLE)).with(new WeaponItemComponent(2)).build()));
        registerable.register(ItemKeys.DIAMOND_SWORD, create(new ItemBase(ItemBaseDisplay.Builder.forItem(ItemKeys.DIAMOND_SWORD).build(), 1), ItemComponentSet.builder().with(ToolItemComponent.from(ToolMaterials.DIAMOND, 2)).with(new WeaponItemComponent(1)).build()));
        registerable.register(ItemKeys.DIAMOND_SHOVEL, create(new ItemBase(ItemBaseDisplay.Builder.forItem(ItemKeys.DIAMOND_SHOVEL).build(), 1), ItemComponentSet.builder().with(ToolItemComponent.from(ToolMaterials.DIAMOND, 1, BlockTags.SHOVEL_MINEABLE)).with(new WeaponItemComponent(2)).build()));
        registerable.register(ItemKeys.DIAMOND_PICKAXE, create(new ItemBase(ItemBaseDisplay.Builder.forItem(ItemKeys.DIAMOND_PICKAXE).build(), 1), ItemComponentSet.builder().with(ToolItemComponent.from(ToolMaterials.DIAMOND, 1, BlockTags.PICKAXE_MINEABLE)).with(new WeaponItemComponent(2)).build()));
        registerable.register(ItemKeys.DIAMOND_AXE, create(new ItemBase(ItemBaseDisplay.Builder.forItem(ItemKeys.DIAMOND_AXE).build(), 1), ItemComponentSet.builder().with(ToolItemComponent.from(ToolMaterials.DIAMOND, 1, BlockTags.AXE_MINEABLE)).with(new WeaponItemComponent(2)).build()));
        registerable.register(ItemKeys.DIAMOND_HOE, create(new ItemBase(ItemBaseDisplay.Builder.forItem(ItemKeys.DIAMOND_HOE).build(), 1), ItemComponentSet.builder().with(ToolItemComponent.from(ToolMaterials.DIAMOND, 1, BlockTags.HOE_MINEABLE)).with(new WeaponItemComponent(2)).build()));
        registerable.register(ItemKeys.NETHERITE_SWORD, create(new ItemBase(ItemBaseDisplay.Builder.forItem(ItemKeys.NETHERITE_SWORD).build(), 1), ItemComponentSet.builder().with(ToolItemComponent.from(ToolMaterials.NETHERITE, 2)).with(new WeaponItemComponent(1)).build()));
        registerable.register(ItemKeys.NETHERITE_SHOVEL, create(new ItemBase(ItemBaseDisplay.Builder.forItem(ItemKeys.NETHERITE_SHOVEL).build(), 1), ItemComponentSet.builder().with(ToolItemComponent.from(ToolMaterials.NETHERITE, 1, BlockTags.SHOVEL_MINEABLE)).with(new WeaponItemComponent(2)).build()));
        registerable.register(ItemKeys.NETHERITE_PICKAXE, create(new ItemBase(ItemBaseDisplay.Builder.forItem(ItemKeys.NETHERITE_PICKAXE).build(), 1), ItemComponentSet.builder().with(ToolItemComponent.from(ToolMaterials.NETHERITE, 1, BlockTags.PICKAXE_MINEABLE)).with(new WeaponItemComponent(2)).build()));
        registerable.register(ItemKeys.NETHERITE_AXE, create(new ItemBase(ItemBaseDisplay.Builder.forItem(ItemKeys.NETHERITE_AXE).build(), 1), ItemComponentSet.builder().with(ToolItemComponent.from(ToolMaterials.NETHERITE, 1, BlockTags.AXE_MINEABLE)).with(new WeaponItemComponent(2)).build()));
        registerable.register(ItemKeys.NETHERITE_HOE, create(new ItemBase(ItemBaseDisplay.Builder.forItem(ItemKeys.NETHERITE_HOE).build(), 1), ItemComponentSet.builder().with(ToolItemComponent.from(ToolMaterials.NETHERITE, 1, BlockTags.HOE_MINEABLE)).with(new WeaponItemComponent(2)).build()));
        ...
        registerable.register(ItemKeys.IRON_CHESTPLATE, create(new ItemBase(ItemBaseDisplay.Builder.forItem(ItemKeys.IRON_CHESTPLATE).build(), 1), ItemComponentSet.builder().with(ArmorItemComponent.from(net.minecraft.item.ArmorMaterials.IRON, ArmorItem.Type.CHESTPLATE, armorMaterials.getOrThrow(ArmorMaterialKeys.IRON))).build()));
        registerable.register(ItemKeys.IRON_LEGGINGS, create(new ItemBase(ItemBaseDisplay.Builder.forItem(ItemKeys.IRON_LEGGINGS).build(), 1), ItemComponentSet.builder().with(ArmorItemComponent.from(net.minecraft.item.ArmorMaterials.IRON, ArmorItem.Type.LEGGINGS, armorMaterials.getOrThrow(ArmorMaterialKeys.IRON))).build()));
        registerable.register(ItemKeys.IRON_BOOTS, create(new ItemBase(ItemBaseDisplay.Builder.forItem(ItemKeys.IRON_BOOTS).build(), 1), ItemComponentSet.builder().with(ArmorItemComponent.from(net.minecraft.item.ArmorMaterials.IRON, ArmorItem.Type.BOOTS, armorMaterials.getOrThrow(ArmorMaterialKeys.IRON))).build()));
