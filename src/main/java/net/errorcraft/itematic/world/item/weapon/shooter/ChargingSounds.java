package net.errorcraft.itematic.world.item.weapon.shooter;
...
public class ChargingSounds {
    ...
    public static final StreamCodec<RegistryFriendlyByteBuf, CrossbowItem.ChargingSounds> STREAM_CODEC = StreamCodec.composite(
