...
public class ItematicRegistryKeys {
    public static final ResourceKey<Registry<ItemBehaviorType<?>>> ITEM_BEHAVIOR_TYPE = ResourceKey.createRegistryKey(Identifier.withDefaultNamespace("item_behavior_type"));
    ...
    public static final ResourceKey<Registry<UseDurationProviderType<?>>> USE_DURATION_PROVIDER_TYPE = ResourceKey.createRegistryKey(Identifier.withDefaultNamespace("use_duration_provider_type"));
    ...
    public static final ResourceKey<Registry<ItemGroupEntryType<?>>> ITEM_GROUP_ENTRY_TYPE = ResourceKey.createRegistryKey(Identifier.withDefaultNamespace("item_group_entry_type"));
