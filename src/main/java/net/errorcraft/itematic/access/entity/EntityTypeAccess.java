...
public interface EntityTypeAccess<T extends Entity> {
    ...
    default T itematic$create(NewActionContext context, SpawnReason reason, BlockPos pos, @Nullable EntitySpawnCallback<T> callback, boolean allowItemData, boolean invertY) {
        return null;
    }
}
