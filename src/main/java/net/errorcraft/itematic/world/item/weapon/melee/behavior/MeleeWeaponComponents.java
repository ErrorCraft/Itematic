...
public class MeleeWeaponComponents {
    public static final Codec<DataComponentType<?>> COMPONENT_CODEC = Codec.lazyInitialized(ItematicBuiltInRegistries.MELEE_WEAPON_COMPONENT_TYPE::byNameCodec);
    ...
    private static <T> DataComponentType<T> register(String id, UnaryOperator<DataComponentType.Builder<T>> builder) {
        return Registry.register(ItematicBuiltInRegistries.MELEE_WEAPON_COMPONENT_TYPE, id, builder.apply(DataComponentType.builder()).build());
    }
}
