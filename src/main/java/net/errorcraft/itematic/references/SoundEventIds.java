...
public class SoundEventIds {
    ...
    public static final ResourceKey<SoundEvent> HONEY_BOTTLE_DRINK = of("item.honey_bottle.drink");
    ...
    public static final ResourceKey<SoundEvent> MUSIC_DISC_5 = of("music_disc.5");
    public static final ResourceKey<SoundEvent> MUSIC_DISC_11 = of("music_disc.11");
    public static final ResourceKey<SoundEvent> MUSIC_DISC_13 = of("music_disc.13");
    public static final ResourceKey<SoundEvent> MUSIC_DISC_BLOCKS = of("music_disc.blocks");
    public static final ResourceKey<SoundEvent> MUSIC_DISC_CAT = of("music_disc.cat");
    public static final ResourceKey<SoundEvent> MUSIC_DISC_CHIRP = of("music_disc.chirp");
    public static final ResourceKey<SoundEvent> MUSIC_DISC_CREATOR = of("music_disc.creator");
    public static final ResourceKey<SoundEvent> MUSIC_DISC_CREATOR_MUSIC_BOX = of("music_disc.creator_music_box");
    public static final ResourceKey<SoundEvent> MUSIC_DISC_FAR = of("music_disc.far");
    public static final ResourceKey<SoundEvent> MUSIC_DISC_MALL = of("music_disc.mall");
    public static final ResourceKey<SoundEvent> MUSIC_DISC_MELLOHI = of("music_disc.mellohi");
    public static final ResourceKey<SoundEvent> MUSIC_DISC_OTHERSIDE = of("music_disc.otherside");
    public static final ResourceKey<SoundEvent> MUSIC_DISC_PIGSTEP = of("music_disc.pigstep");
    public static final ResourceKey<SoundEvent> MUSIC_DISC_PRECIPICE = of("music_disc.precipice");
    public static final ResourceKey<SoundEvent> MUSIC_DISC_RELIC = of("music_disc.relic");
    public static final ResourceKey<SoundEvent> MUSIC_DISC_STAL = of("music_disc.stal");
    public static final ResourceKey<SoundEvent> MUSIC_DISC_STRAD = of("music_disc.strad");
    public static final ResourceKey<SoundEvent> MUSIC_DISC_WAIT = of("music_disc.wait");
    public static final ResourceKey<SoundEvent> MUSIC_DISC_WARD = of("music_disc.ward");
