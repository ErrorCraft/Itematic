...
public class Trades {
    ...
    public static void bootstrap(Registerable<Trade> registerable) {
        ...
        registerable.register(SELL_MONUMENT_MAP, sellMap(items, 13, StructureTags.ON_OCEAN_EXPLORER_MAPS, "filled_map.monument", MapIcon.Type.MONUMENT, TradeOffersAccessor.apprenticeSellTradeExperience()));
        ...
        registerable.register(SELL_MANSION_MAP, sellMap(items, 14, StructureTags.ON_WOODLAND_EXPLORER_MAPS, "filled_map.mansion", MapIcon.Type.MANSION, TradeOffersAccessor.journeymanSellTradeExperience()));
    ...
    private static Trade sellMap(RegistryEntryLookup<Item> items, int price, TagKey<Structure> structure, String name, MapIcon.Type iconType, int tradeExperience) {
