...
import net.errorcraft.itematic.access.core.HolderSetAccess;
...
public interface HolderSetExtender<T> extends HolderSetAccess<T> {
    @Mixin(HolderSet.ListBacked.class)
    abstract class ListBackedExtender<T> implements HolderSetAccess<T> {
        @Shadow
